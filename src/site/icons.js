...
const ICONS = {
  ...
  search: {
    desk: '<circle cx="10.8" cy="10.8" r="6.3"/><path d="m15.4 15.4 4.1 4.1"/>',
    mob: '<path fill="currentColor" stroke="none" d="M10.8 3.6a7.2 7.2 0 1 0 4.2 13.05l3.5 3.5a1.5 1.5 0 0 0 2.1-2.1l-3.5-3.5A7.2 7.2 0 0 0 10.8 3.6Zm0 3a4.2 4.2 0 1 1 0 8.4 4.2 4.2 0 0 1 0-8.4Z"/>',
  },
  trend: {

...
One per machine, in the order they are listed in `src/data/machines.json`. Cut out
on a white background if you can: the card places them with `object-fit: contain`,
so a cut-out sits on the card cleanly at any crop.

| File | Machine | Suggested size |
| ---- | ------- | -------------- |
| `vmax1` | VX-L350 Wheel Loader | 1200 x 900 |
| `vmax2` | VX-L260 Wheel Loader | 1200 x 900 |
| `vmax3` | VX-L220 Wheel Loader | 1200 x 900 |
| `vmax4` | VX-H200 High Lift Loader | 1200 x 900 |
| `vmax5` | VX-E480 Crawler Excavator | 1200 x 900 |
| `vmax6` | VX-E220 Crawler Excavator | 1200 x 900 |
| `vmax7` | VX-D90 Crawler Dozer | 1200 x 900 |
| `vmax8` | VX-A45 Articulated Hauler | 1200 x 900 |
| `vmax9` | VX-G160 Motor Grader | 1200 x 900 |
| `vmax10` | VX-B120 Backhoe Loader | 1200 x 900 |
| `vmax11` | VX-R140 Soil Compactor | 1200 x 900 |
| `vmax12` | VX-T70 Telehandler | 1200 x 900 |
...
| `public/favicon.png` | Browser tab | 512 x 512 |
| `public/favicon.ico` | Browser tab, legacy | 32 x 32 |
| `public/apple-touch-icon.png` | iOS home screen | 180 x 180 |

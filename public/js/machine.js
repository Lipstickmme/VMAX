    ...
    root.innerHTML = `
      <header class="machine-hero">
        <div class="wrap machine-hero-grid">
          ...
          <div class="machine-hero-media">${V.media(m.image, { alt: m.name, eager: true })}</div>
        </div>
      </header>
      ...
      <nav class="next-nav"><div class="wrap"><a href="/machines/${esc(next.id)}">
